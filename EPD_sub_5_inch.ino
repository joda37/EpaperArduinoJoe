...
#define PDI_EPD_Size EPD_266
    ...
    #define BW_monoBuffer        (uint8_t *) & image_154_152x152_BW_monoTest
    
    #define BW_monoBuffer1        (uint8_t *) & image_154_152x152_BW_mono1
    #define BW_monoBuffer2        (uint8_t *) & image_154_152x152_BW_mono2
    #define BW_monoBuffer3        (uint8_t *) & image_154_152x152_BW_mono3
    #define BW_monoBuffer4        (uint8_t *) & image_154_152x152_BW_mono4
...
// Send 2nd image data for black and white colors
  ...
  // Send 4th image data for black and white colors
  sendIndexData( 0x10, BW_monoBuffer4, image_data_size[PDI_EPD_Size] );  //First frame: black frame where 1=black and 0=white pixel
  sendIndexData( 0x13, BW_0x00Buffer, image_data_size[PDI_EPD_Size] );  //Second frame: all 0x00
  ...
  delay( 5000 );
	...
	//sendIndexData( 0x13, BW_0x00Buffer, image_data_size[PDI_EPD_Size] );	//Second frame: color frame where 1=color and 0=white or black pixel
